...
module.exports = {
  ...
  */
  ...
  plugins: [{ src: '~plugins/appendImg.js', ssr: false }, '~plugins/filter.js', '~plugins/i18n.js',
  // '~plugins/dictionary.js',
  '~plugins/api.js', '~plugins/st-ui.js', '~plugins/enum.js', { src: '~plugins/udesk.js', ssr: false }, { src: '~plugins/baidu.js', ssr: false }],
  // modules: [
...
async function start() {
  ...
  app.use(async (ctx, next) => {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a((resolve, reject) => {
